    ...
    attach: function (context, settings) {
      ...
      $('.edoweb.entity.edit', context).each(function() {
        ...
        additional_fields.change(function() {
          ...
          if(bundle=='researchData' || bundle=='article' || bundle== 'monograph' || bundle=='journal' || bundle=='webpage' || bundle=='orca'){
        ...
        $.post(url, post_data, function(data, textStatus, jqXHR) {
          ...
          if (subject.type == 'bnode') {
            entity_load_json('edoweb_basic', resource_uri).onload = function() {
              if (bundle == 'monograph' || bundle=='webpage' || bundle == 'journal' || bundle=='proceeding'|| bundle=='researchData' || bundle=='article' || bundle=='orca') {
